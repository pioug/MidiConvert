...
a.velocity?"noteOff":"noteOn",a;case 10:return a.subtype="noteAftertouch",a.noteNumber=b,a.amount=c.readInt8(),a;case 11:return a.subtype="controller",a.controllerType=b,a.value=c.readInt8(),a;case 12:return a.subtype="programChange",a.programNumber=b,a;case 13:return a.subtype="channelAftertouch",a.amount=b,a;case 14:return a.subtype="pitchBend",a.value=b+(c.readInt8()<<7),a;default:throw"Unrecognised MIDI event type: "+e;}}var n;k=r(k);var g=e(k),h=[],l,m,p;if("MThd"!==g.id||6!==g.length)throw"Bad .mid file - header not found";
l=r(g.data);g=l.readInt16();m=l.readInt16();l=l.readInt16();if(l&32768)throw"Expressing time division in SMTPE frames is not supported yet";g={formatType:g,trackCount:m,ticksPerBeat:l};for(m=0;m<g.trackCount;m++){h[m]=[];l=e(k);if("MTrk"!==l.id)throw"Unexpected chunk - expected MTrk, got "+l.id;for(l=r(l.data);!l.eof();)p=f(l),h[m].push(p)}return{header:g,tracks:h}}return{parse:function(k,e){k=t(k);if(0===k.header.formatType){var f={},n=0,g=[],h,l,m,p,c;for(c=0;c<k.tracks[0].length;c++)h=k.tracks[0][c],
...
break}}else if("meta"===d.type&&"trackName"===d.subtype)d=d.text,d.replace(/\u0000/g,"");else if(64===d.controllerType)if(64<=d.value&&!n)d={_ticks:h,eventName:"sustain",time:h},n=!0,g.push(d);else if(64>d.value&&n){for(a=g.length-1;0<=a;a--)if(b=g[a],"sustain"===b.eventName&&"undefined"===typeof b.duration){e.duration&&(b.duration=Math.round((h-b._ticks)/f*e.PPQ)+"i");b.time=Math.round(b.time/f*e.PPQ)+"i";delete b._note;delete b._ticks;break}n=!1}0<g.length&&p.push(g)}var f={instruments:[]},n={},
q;for(e=0;e<k.tracks.length;e++)for(q=k.tracks[e],g=0;g<q.length;g++)h=q[g],"meta"===h.type?"timeSignature"===h.subtype?f.timeSignature=[h.numerator,h.denominator]:"setTempo"===h.subtype&&(f.bpm=6E7/h.microsecondsPerBeat):"channel"===h.type&&"programChange"===h.subtype&&(n[h.channel]=9===h.channel?0:h.programNumber+1);for(q in n)n.hasOwnProperty(q)&&f.instruments.push(n[q]);return{parts:p,transport:f}}}});
