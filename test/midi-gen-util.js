...
ava('Midi -> Util -> ticksToSeconds', function(t) {
  ...
  tests.map(function([ticks, bpm, result]) {
    t.deepEqual(Util.ticksToSeconds(ticks, bpm, 128), result, 'ticksToSeconds converts ticks to seconds');
  });
});
...
ava('Midi -> Util -> secondsToTicks', function(t) {
  ...
  tests.map(function([seconds, bpm, result]) {
    t.deepEqual(Util.secondsToTicks(seconds, bpm, 128), result, 'ticksToSeconds converts seconds to ticks by rounding up');
  });
});
